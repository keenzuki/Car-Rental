...
<head>
      ...
      <style>
          ...
          .vertical-rule {
            border-left: 1px solid #454749; /* Adjust the color as needed */
            height: 100%;
        }
    ...
    <nav class="navbar navbar-expand-lg navbar-white shadow-sm border-bottom">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="4000">
               <img src="images/vehicle 1.jpg" alt="no image" class="img-fluid rounded-5 intro-img">
                <div class="opacity-100 img-overlay position-absolute top-0 start-20 w-100 h-100 d-flex flex-column justify-content-center">
                  <div class="display-3 text-white" style="margin-left: 20px; font-weight:400">Rent with us</div>
                </div>
              </div>
              <div class="carousel-item" data-bs-interval="4000">
                <img src="images/vehicle 2.jpg" alt="no image" class="img-fluid rounded-5 intro-img">
                <div class="opacity-100 img-overlay position-absolute top-0 start-0 w-100 h-100 text-center d-flex flex-column justify-content-center">
              ...
              <div class="carousel-item" data-bs-interval="4000">
                ...
                <div class="opacity-100 img-overlay position-absolute top-0 start-0 end-0 w-100 h-100 d-flex flex-column justify-content-center">
                  <div class="display-3 text-white" style="margin-left: auto; margin-right: 20px; font-weight:400">Experience new heights</div>
                </div>
               </div>
            </div>
          </div>
      ...
      <div class="container-xxl mt-3">
        ...
        <div class="row justify-content-around mt-2 overflow-auto">
          ...
          <div class="type-img">
            <a href="#">
            <img src="images/Mini-van.jpg" alt="Mini-van" class="img-fluid rounded-5" style="height: 100%">
                <div class="opacity-100 img-overlay position-absolute top-0 start-0 w-100 h-100 text-center d-flex flex-column justify-content-center">
        ...
        <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 justify-content-between mt-3">
          ...
          <div class="col">
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-5">
                  <img src="images/BMW-M3-E46.jpeg" class="img-fluid cars rounded-start" alt="..." style="height: 56%">
                ...
                <div class="col-7">
                  <div class="card-body text-end p-3">
                    ...
                    <p class="fw-semibold mb-0 px-2"><small>5 People <i class="bi bi-person-fill ms-2" style="font-size: 20px"></i></small></p>
                    <p class="fw-semibold mb-0 px-2"><small>Manual <i class="bi bi-gear-fill ms-2" style="font-size: 20px"></i></small></p>
                    <p class="fw-semibold px-2"><small>Petrol <i class="bi bi-fuel-pump-fill ms-2" style="font-size: 20px"></i></small></p>
          ...
          <div class="col">
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-5">
                  <img src="images/M-C200.jpeg" class="img-fluid cars rounded-start" alt="..." style="height: 56%">
                  <h3 class="ms-2 fw-bold mb-0">Ksh. 4,000</h3>
                  <p class="ms-5 mt-0"><small>per day</small></p>
                </div>
                <div class="col-7">
          ...
          <div class="col">
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-5">
                  <img src="images/Subaru_IMPREZA.webp" class="img-fluid cars rounded-start" alt="..." style="height: 56%">
                  <h3 class="ms-2 fw-bold mb-0">Ksh. 4,000</h3>
                  <p class="ms-5 mt-0"><small>per day</small></p>
                </div>
                <div class="col-7">
              ...
              <div class="row g-0">
                ...
                <div class="col-7">
                  <div class="card-body text-end p-3">
                    <h5 class="card-title">Sedan 4 Door Car</h5>
                    <p class="mb-1 fw-semibold"><small>BMW M3 E46</small></p>
                    <p class="fw-semibold px-2 mb-0"><small>5 People<i class="bi bi-person-fill ms-2" style="font-size: 20px"></i></small></p>
                    <p class="fw-semibold px-2 mb-0"><small>Manual <i class="bi bi-gear-fill ms-2" style="font-size: 20px"></i></small></p>
                    <p class="fw-semibold px-2"><small>Petrol <i class="bi bi-fuel-pump-fill ms-2" style="font-size: 20px"></i></small></p>
                    <a href="#" class="px-4 me-2 text-start btn btn-outline-secondary">Reserve</a>
                  </div>
                </div>
      ...
      {{-- offcanvas --}}
      <div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel" style="height: 550px;">
            ...
            <div class="col">
              <div class="card">
                ...
                <div class="card-body text-center">
                    <h5 class="card-title">Sedan 4 Door Car</h5>
                    <p class="mb-1 fw-semibold"><small>BMW M3 E46</small></p>
                    <p class="fw-semibold mb-2"><i class="bi bi-person-fill ms-0" style="font-size: 20px"></i><small class="ms-1">5 People</small>
                      <i class="bi bi-gear-fill ms-4" style="font-size: 20px"></i><small class="ms-1">Manual</small>
                      <i class="bi bi-fuel-pump-fill ms-4" style="font-size: 20px"></i><small class="ms-1">Petrol</small>
                    </p>
          ...
          <div class="col-lg-6">
            ...
            <div class="accordion" id="accordionFAQs">
              <div class="accordion-item mb-lg-5">
                <h1 class="accordion-header text-dark fw-bold" style="font-size:30px; font-weight:640">
                  ...
                  <h3 class="text-dark" style="font-size: 17px;font-weight:500">Frequently Asked Questions</h1>
                  </button>
                </h1>
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFAQs">
                  <div class="accordion-body">
                    ...
                    <p><small class="mt-0">All you need when renting a car with us is your national ID and sufficient funds to pay for the renting services.
                      At the time of collecting the car you will need the National ID together with your driver's license.</small></p>
            ...
            <div class="accordion pt-2" id="accordionTips">
              <div class="accordion-item">
                ...
                <div id="flush-collapsetwo" class="accordion-collapse collapse" data-bs-parent="#accordionTips">
                  <div class="accordion-body">
                    <p><small>1. If you hiring for family or friends road trip, you might consider bigger vehicles like mini vans and SUVs so you can enjoy
        ...
        <div class="container-xxl">
          <div class="row mt-5 d-flex justify-content-between py-5">
            ...
            <div class="col-6 col-md-3">
              ...
              <p><small> We give you reliable and affordable car hire in Nairobi. Unbeatable car rental deals and excellent service to our clients.</small></p>
            </div>
            ...
            <div class="col-6 col-md-3">
              ...
              <p><a href="#" class="text-dark"><i class="bi bi-facebook" style="font-size: 25px" data-bs-toggle="tooltip" data-bs-placement="bottom" title="facebook"></i></a>
                <a href="#" class="text-dark"><i class="bi bi-twitter-x ms-3" style="font-size: 20px" data-bs-toggle="tooltip" data-bs-placement="bottom" title="twitter"></i></a>
                <a href="#" class="text-dark"><i class="bi bi-instagram ms-3" style="font-size: 20px" data-bs-toggle="tooltip" data-bs-placement="bottom" title="instagram"></i></a>
              </p>
            </div>
            ...
            <div class="col-6 col-md-2">
              ...
              <a href="#" class="text-dark" style="text-decoration: none"><p>About Us</p></a>
              <a href="#" class="text-dark" style="text-decoration: none"><p>Contact Us</p></a>
              <a href="#" class="text-dark" style="text-decoration: none"><p>Policy</p></a>
            </div>
